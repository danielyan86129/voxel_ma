...
//
// read in a volume file (user should use this as much as possible instead of
// the other specific readers)
...
//
// import voro info from a set of tetgen files (deduced from given file base
// name)
// @param _sites_pos_file: optionally import the contributing sites from the
// given file
...
// simply parse all voro files (from tetgen) to profile I/O time
ImportErrCode profileVoroInfoIO(const char* _basename);
//
