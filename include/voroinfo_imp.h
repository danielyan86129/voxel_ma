...
namespace voxelvoro {
	...
	inline bool VoroInfo::computeFaceValidity( int _fi ) const
	{
		...
		for ( auto v : f_vts )
			if ( !isVertexValid( v ) ) return false;
		return true;
	}
