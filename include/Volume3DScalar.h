...
//////////////////////////////////////////////////////////////////////////
/// This is the abstract class for a 3d volume storing a scalar value at each voxel
//////////////////////////////////////////////////////////////////////////
...
public:
	...
	const trimesh::xform& getVoxToModelMat() const
	{
		return m_vox_to_mesh;
	}
	const trimesh::xform& getModeltoVoxMat() const
	{
		return m_mesh_to_vox;
	}
