...
{
public:
	enum celltype {FACE = 1, EDGE = 0, VERTEX = 2};
	struct simple_pair
	{
		enum spairtype {FE_PAIR = 1, EV_PAIR = 0};
...
private:
	...
	//
	bool face_edge_pair_below_threshold(unsigned _fi, unsigned _ei, float _f_t, float _e_t) const;
	//
	// 
	//
