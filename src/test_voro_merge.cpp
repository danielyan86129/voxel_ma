...
vector<vector<int>> faces = {
    vector<int>({0, 1, 2, 3}), vector<int>({1, 2, 4}), vector<int>({1, 4, 5}),
    vector<int>({4, 5, 7, 6}), vector<int>({0, 3, 8}), vector<int>({0, 8, 9})};
vector<bool> vert_valid_tag = {true, true, true, true, true,
                               true, true, true, true, true};
vector<bool> is_finite_v = {true, true, true, true, true,
                            true, true, true, true, true};
// must indicate for each edge its finiteness
vector<bool> is_finite_e = {true, true, true, true, true, true,
                            true, true, true, true, true, true,
                            true, true, true, true, true};
vector<bool> is_finite_f = {true, true, true, true, true, true};

void main(void)
{
    VoroInfo voro;
    cout << "filling voro with given info ..." << endl;
    voro.setInfo(vts, edges, faces, vert_valid_tag, is_finite_v, is_finite_e,
                 is_finite_f);
